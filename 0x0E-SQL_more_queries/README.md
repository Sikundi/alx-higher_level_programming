...
In this project, I ccontinued to practice SQL queries, working with permissions, joins and cconstraints.

## Usage :dolphin:

* Scripts [3-force_name.sql](./3-force_name.sql) forward take the database query from 
